...
/*
 * Project RobotSubscriber
 * Description: Subscriber subscribes to Capture event.
 * Captures an image and sends data to TCP Server
...
void setup()
{
//Suscribes capture event and invokes myhandler method
...
//This method captures photo and sends data to TCP server
...
// Loop does nothing in this code
void loop()
{
